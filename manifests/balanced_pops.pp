...
#
# [*active_node*]
#   For pops balacement we use A/P balancement. Only hostname specified with this parameter will be considered up. Other hosts will be used as backup
#
# == Example
#
...
#   - we want to balance pops service on bar cluster through foo balancer. bar01 will be the active node
#
# node clusterfoo {
#   haproxy::generic_tcp_balance {"clusterbar_pops":
#     port            => '110',
#     bind_addresses  => $vip,
#   }
#
