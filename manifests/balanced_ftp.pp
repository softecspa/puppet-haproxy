...
# Balancer will put this host in ftp backend servers
#
# == Params
#
# [*cluster_balancer*]
...
#
# [*active_node*]
#   For ftp balacement we use A/P balancement. Only hostname specified with this parameter will be considered up. Other hosts will be used as backup
#
# == Example
#
...
#   - we want to balance ftp service on bar cluster through foo balancer. bar01 will be the active node
#
# node clusterfoo {
#   haproxy::ftp_balance {"clusterbar_ftp":
